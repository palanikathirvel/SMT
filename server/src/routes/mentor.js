...
// get mentor requests
router.get("/requests", Auth, Authorize(Role.Mentor), mentorController.getMentorRequests);
...
router.post(
    ...
    Logger(events.MENTOR_REQUEST_ACCEPTED)
);
...
router.post(
    ...
    Logger(events.MENTOR_REQUEST_REJECTED)
);
