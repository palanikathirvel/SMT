...
export const getMentorRequests = () =>
    API.get("/mentor/requests").catch((error) => {
        return error.response;
    });

export const acceptMentorRequest = (fields) =>
    API.post("/mentor/requests/accept", fields).catch((error) => {
        return error.response;
    });

export const rejectMentorRequest = (fields) =>
    API.post("/mentor/requests/reject", fields).catch((error) => {
        return error.response;
    });
