...
module.exports = {
    ...
    MENTOR_REQUEST_SENT: {
        ...
        detail: "Sent mentor request",
        model: "MentorRequest",
    },
    MENTOR_REQUEST_ACCEPTED: {
        type: "MENTOR_REQUEST_ACCEPTED",
        detail: "Accepted mentor request",
        model: "MentorRequest",
    },
    MENTOR_REQUEST_REJECTED: {
        type: "MENTOR_REQUEST_REJECTED",
        detail: "Rejected mentor request",
        model: "MentorRequest",
    },
    AI_CHAT_MESSAGE: {
        type: "AI_CHAT_MESSAGE",
        detail: "Sent message to AI chatbot",
        model: "AiChat",
    },
    SKILLS_UPDATED: {
        type: "SKILLS_UPDATED",
        detail: "Updated skills/expertise",
    },
};
