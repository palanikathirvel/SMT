...
export const getMentorRequests = (setRequests) => async (dispatch) => {
    try {
...
export const acceptMentorRequest = (requestId, onSuccess) => async (dispatch) => {
    try {
        const { data } = await api.acceptMentorRequest({ requestId });
        console.log("accept mentor request", data);
...
export const rejectMentorRequest = (requestId, onSuccess) => async (dispatch) => {
    try {
        const { data } = await api.rejectMentorRequest({ requestId });
        console.log("reject mentor request", data);
