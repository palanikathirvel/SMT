...
export const getAvailableMentors = () =>
    API.get("/student/mentors").catch((error) => {
        return error.response;
    });

export const sendMentorRequest = (fields) =>
    API.post("/student/mentor-request", fields).catch((error) => {
        return error.response;
    });

export const getMyMentorRequests = () =>
    API.get("/student/mentor-requests").catch((error) => {
        return error.response;
    });
