...
// DEPRECATED: Manual allocation routes removed in favor of student-initiated requests
// router.post("/saveGroup", Auth, Authorize(Role.Admin), adminController.saveGroup, Logger(events.GROUP_UPDATE));
